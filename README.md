# Team03_LearningManagementSystem
...
```
cd existing_repo
git remote add origin http://git.fa.edu.vn/hcm24_cpl_java_12/team-3/team03_learningmanagementsystem.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.fa.edu.vn/hcm24_cpl_java_12/team-3/team03_learningmanagementsystem/-/settings/integrations)
